...
starting with the prefixes _java_ and _jakarta_ are reserved by the
different specifications of the Java platform. The _jakarta.servlet_
...
link:jsp.html#a1170[See jakarta.el.StaticFieldResolver.].
...
description for jakarta.servlet.jsp.tagext in Part II, after "1.Classic
...
jakarta.servlet.jsp.tagext in Part II, under the topic " Invocation of a
...
getAttributeNamesInScope method in jakarta.servlet.jsp.JspContext from
...
_jakarta.el.ExpressionFactory._
...
jakarta.servlet.jsp.tagext now clarifies how deferred expressions are
...
jakarta.el.ResourceBundleResolver and link:jsp.html#a1164[See
Resolution of Variables and their Properties.].
...
_jakarta.servlet.jsp.tagext.TagLibraryValidator:setInitParameters(),
jakarta.servlet.jsp.tagext.TagData:getAttributes(),
jakarta.servlet.jsp.tagext.TagSupport:getValues(),
jakarta.servlet.jsp.tagext.SimpleTagSupport:findAncestorWithClass()_ .
...
jakarta.servlet.jsp.tagext.TagInfo have been updated to be consistent with
...
cannot evaluate to a valid _jakarta.el.MethodExpression_ .
...
_jakarta.servlet.jsp.tagext.JspIdConsumer_ makes this possible.
...
=== New class _jakarta.servlet.jsp.JspApplicationContext_
...
=== Major changes to the _jakarta.servlet.jsp.el_ API

All of the classes and interfaces of the
_jakarta.servlet.jsp.el_ API have been deprecated. The APIs defined by the
unified Expression Language ( _jakarta.el_ ) should be used as of JSP 2.1.
...
unified Expression Language. See link:jakarta.servlet.jsp.el.html#UNKNOWN[].
...
in a JSP page or tag file. See link:jakarta.servlet.jsp.html#UNKNOWN[] and
...
* API Changes:
* Changed
_jakarta.servlet.jsp.tagext.JspFragment_ from an interface to an abstract
...
error pages by adding _jakarta.servlet.error.exception_ and providing
...
* Added _jakarta.servlet.jsp.tagext.JspTag_ to
the API chapter.
* Fixed EBNF for _Params_ , _Fallback_
productions.
...
* Removed
_jakarta.servlet.jsp.tagext.AttributeNotSupportedException_ , and replaced
...
API chapter for _jakarta.servlet.jsp.el_ package.
...
link:jakarta.servlet.jsp.tagext.html#UNKNOWN[]
(link:jakarta.servlet.jsp.tagext.html#UNKNOWN[]) were affected.
...
safe. This affected link:jakarta.servlet.jsp.tagext.html#UNKNOWN[].
...
clarification affected link:jakarta.servlet.jsp.tagext.html#UNKNOWN[].
...
link:jakarta.servlet.jsp.html#UNKNOWN[] and
link:jakarta.servlet.jsp.tagext.html#UNKNOWN[] which are generated
...
link:JSP_Syntax.html#UNKNOWN[].
* Renamed jakarta.servlet.jsp.tagext.PageInfo
to jakarta.servlet.jsp.tagext.PageData (for consistency with existing
TagData).
